...
import com.way.mms.common.BlockedConversationHelper;
import com.way.mms.common.ConversationPrefsHelper;
import com.way.mms.common.utils.MLog;
import com.way.mms.common.utils.PackageUtils;
import com.way.mms.data.Message;
import com.way.mms.service.NotificationService;
...
public class MessagingReceiver extends BroadcastReceiver {
    private final String TAG = "Mms:MessagingReceiver";
