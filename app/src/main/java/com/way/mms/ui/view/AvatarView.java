...
import com.way.mms.common.utils.ImageUtils;
...
public class AvatarView extends AppCompatImageView implements View.OnClickListener {
    ...
    public AvatarView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (!isInEditMode()) {
            ...
            final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.AvatarView, defStyleAttr, 0);
    ...
    /**
     * @return True if a contact, an email address or a phone number has been assigned
     */
